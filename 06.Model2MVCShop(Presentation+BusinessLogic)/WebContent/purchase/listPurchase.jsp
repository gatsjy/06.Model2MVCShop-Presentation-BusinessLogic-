...
<script type="text/javascript">
function UpdateReview(tranNo){
 	popWin = window.open("/updatePurchaseReviewView.do?tranNo="+tranNo,"popWin","left=300, top=200, width=700, height=500, marginwidth=0, marginheight=0, scrollbars=no, scrolling=no, menubar=no, resizable=no");
}
</script>	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 10px;">
	...
	<tr class="ct_list_pop">
		...
		<td align="center">
			...
			<a href="javascript:UpdateReview(${purchase.tranNo})"> *별점주기</a>
			</c:if> 
			</c:if>
			</td>
		<td></td>
