...
function fncUpdatePurchaseReview() {
	document.updatePurchaseReview.submit();
}
...
<form name="updatePurchaseReview" method="post" action="/updatePurchaseReview.do?tranNo=${purchase.tranNo}">
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<select name="star"  class="ct_input_g" 
