...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		<td width="104" class="ct_write">구매량</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">${purchase.purchaseQuantity}개</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">${purchase.purchasePrice}원</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<c:if test="${purchase.tranCode=='1'}">
						<a href="/cancelPurchase.do?tranNo=${purchase.tranNo}&purchaseQuantity=${purchase.purchaseQuantity}&prodNo=${purchase.purchaseProd.prodNo}">구매취소</a>
					</c:if>
					</td>
					<td width="14" height="23">
						<img src="/images/ct_btnbg03.gif"width="14" height="23"/>
