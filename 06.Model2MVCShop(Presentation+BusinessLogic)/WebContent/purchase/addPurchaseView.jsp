...
function fncAddPurchase() {
	...
	var purchaseQuantity=document.detailForm.purchaseQuantity.value;
	...
	<tr>
		...
		<td background="/images/ct_ttl_img02.gif" width="100%" style="padding-left: 10px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="93%" class="ct_ttl01">물품구매내역</td>
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input		type="text" name="purchaseQuantity" 	class="ct_input_g" 
							style="width: 100px; height: 19px" maxLength="20" />
		남은수량(${product.prodQuantity })<input	type="hidden" name="productQuantity" value="${product.prodQuantity}">			
		</td>
	</tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
