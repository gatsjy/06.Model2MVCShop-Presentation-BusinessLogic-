...
<form name="detailForm" action="/listSale.do?tranNo=${tranNo}" method="post">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td class="ct_line02"></td>
				<td class="ct_list_b" width="150">구매액</td>
				<td class="ct_line02"></td>
				<td class="ct_list_b" width="150">구매물량/남은물량</td>
				<td class="ct_line02"></td>
				<td class="ct_list_b" width="150">배송</td>
			</tr>
			<tr>
			...
			<c:forEach var="purchase" items="${list}">
				...
				<tr class="ct_list_pop">
					...
					<a href="/updateTranCodeByTranNo.do?tranNo=${purchase.tranNo}&tranCode=2">배송하기</a>
					</c:if>
