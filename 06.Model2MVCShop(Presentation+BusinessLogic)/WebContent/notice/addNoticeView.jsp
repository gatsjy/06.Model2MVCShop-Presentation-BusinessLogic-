	...
	<tr>
		...
		<td background="/images/ct_ttl_img02.gif" width="100%" style="padding-left: 10px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="93%" class="ct_ttl01">공지사항등록</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<textarea name="noticeDetail" class="ct_input_g" cols = "80" rows = "20"
						 maxLength="500" minLength="6" value="전하고 싶은말을 적어주세요"/></textarea>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="noticeId"  class="ct_input_g" 
						style="width: 100px; height: 19px" maxLength="10" value="${sessionScope.user.userId}">&nbsp;
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td background="/images/ct_btnbg02.gif" class="ct_btn01"  style="padding-top: 3px;">
					<a href="javascript:fncAddNotice();">등록</a>
				</td>
