			...
			<form name="detailForm" action="/listProduct.do?menu=search" method="post">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<td class="ct_line02"></td>
						<td class="ct_list_b" width="150"><a href="/listProduct.do?menu=search&searchSorting=1">평점</a></td>
						<td class="ct_line02"></td>
					</tr>
					<tr>
					...
					<c:forEach var="product" items="${list}">
						...
						<tr class="ct_list_pop" width="150">
							...
							<td></td>
							<td align="center"><a
								href="/getProduct.do?prodNo=${product.prodNo}&menu=search">${product.prodNo}</a>
							</td>
							<td></td>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<input type="hidden" id="searchSorting" name="searchSorting" value="${search.searchSorting}" />
...
<c:if test="${param.menu=='manage' }">
	<form name="detailForm" action="/listProduct.do?menu=manage" method="post">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			style="margin-top: 10px;">
			<tr>
				<td colspan="11">전체 ${resultPage.totalCount}건수,
			...
			<tr>
				...
				<td class="ct_list_b" width="150">현재상태</td>
				<td class="ct_line02"></td>
				<td class="ct_list_b" width="150">남은물량</td>
			</tr>
			<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			style="margin-top: 10px;">
			<tr>
				<td align="center"><input type="hidden" id="currentPage" name="currentPage" value="${resultPage.currentPage}" /> 
