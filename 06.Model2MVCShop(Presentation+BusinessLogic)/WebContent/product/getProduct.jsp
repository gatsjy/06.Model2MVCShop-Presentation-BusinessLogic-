	...
	<form name="detailForm" method="post">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td bgcolor="D6D6D6" width="1"></td>
				<td class="ct_write01">${product.star}</td>
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			</tr>
			...
			<tr>
					...
					<c:forEach var="product" items="${reviewlist}">
						...
						<tr class="ct_list_pop" width="150">
							...
							<td></td>
							<td align="center"><a>구매리뷰 : ${product.review}</a>
							</td>
			...
			<tr>
							...
							<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
								<c:if test= "${product.prodQuantity!=0}">
									...
									<td width="30" height="23"><img src="/images/ct_btnbg01.gif" width="17" height="23" /></td>
							<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
								<a href="/addCartView.do?prodNo=${product.prodNo}">장바구니</a></td>		
								</c:if> 
							</td>
