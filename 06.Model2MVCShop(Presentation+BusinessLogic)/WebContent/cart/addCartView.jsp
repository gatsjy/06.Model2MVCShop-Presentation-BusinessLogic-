...
<form name="addCart" method="post" action="/addCart.do?prodNo=${product.prodNo}">
	...
	<tr>
		...
		<td background="/images/ct_ttl_img02.gif" width="100%" style="padding-left: 10px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="93%" class="ct_ttl01">장바구니 등록</td>
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="purchaseQuantity" 	class="ct_input_g"  style="width: 100px; height: 19px" maxLength="20" />
				남은수량(${product.prodQuantity })
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
						<a href="javascript:fncAddCart();">등록</a>
					</td>
